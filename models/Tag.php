...
class Tag extends ModelAbstract
{
    ...
    const TABLE_NAME = 'webbook_blogtaxonomy_tags';

    /** @deprecated */
    const CROSS_REFERENCE_TABLE_NAME = 'webbook_blogtaxonomy_post_tag';

    const PIVOT_COLUMN = 'webbook_blogtaxonomy_taggable';

    const PIVOT_TABLE = 'webbook_blogtaxonomy_taggables';
